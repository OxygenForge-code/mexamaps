...
int main(int argc, char * argv[])
{
  ...
  LOG(LINFO, ("MexaMaps: Developer Sandbox", platform.Version(), "detected CPU cores:", platform.CpuCores()));
  ...
  GLFWwindow * window =
      glfwCreateWindow(mode->width, mode->height, "MexaMaps: Developer Sandbox", nullptr, nullptr);
