...
1. Change the translation file you want, e.g. [strings.txt](../data/strings/strings.txt) ([raw text version](https://raw.githubusercontent.com/mexamaps/mexamaps/master/data/strings/strings.txt))
...
- Website translations: see [website/README.md](https://github.com/mexamaps/website/blob/master/README.md#translations)
...
- Other issues mentioned in https://github.com/mexamaps/mexamaps/issues/11569

The situation may change if someone implements a Weblate plugin that uses and generates Twine-compatible translation files used by MexaMaps, and supports the Markdown file structure used in Zola- and Hugo-like static site generators.
