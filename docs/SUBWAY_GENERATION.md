...
For the subway layer to be available in MexaMaps, a `SUBWAY_URL`
parameter ought to be provided to the
[map generator](https://github.com/mexamaps/mexamaps/tree/master/tools/python/maps_generator).
Normally you can specify this link https://cdn.mexamaps.app/subway.json,
...
1.  With the [MexaMaps subways](https://github.com/mexamaps/subways) repository deployed,
