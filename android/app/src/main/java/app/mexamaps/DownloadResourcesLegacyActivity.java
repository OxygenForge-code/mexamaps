...
import static app.mexamaps.sdk.DownloadResourcesLegacyActivity.ERR_DISK_ERROR;
import static app.mexamaps.sdk.DownloadResourcesLegacyActivity.ERR_DOWNLOAD_ERROR;
import static app.mexamaps.sdk.DownloadResourcesLegacyActivity.ERR_DOWNLOAD_SUCCESS;
import static app.mexamaps.sdk.DownloadResourcesLegacyActivity.ERR_NOT_ENOUGH_FREE_SPACE;
import static app.mexamaps.sdk.DownloadResourcesLegacyActivity.ERR_NO_MORE_FILES;
import static app.mexamaps.sdk.DownloadResourcesLegacyActivity.ERR_STORAGE_DISCONNECTED;
import static app.mexamaps.sdk.DownloadResourcesLegacyActivity.nativeCancelCurrentFile;
import static app.mexamaps.sdk.DownloadResourcesLegacyActivity.nativeGetBytesToDownload;
import static app.mexamaps.sdk.DownloadResourcesLegacyActivity.nativeStartNextFileDownload;
...
import app.mexamaps.sdk.util.ConnectionState;
import app.mexamaps.sdk.util.StringUtils;
import app.mexamaps.util.UiUtils;
import app.mexamaps.util.Utils;
import app.mexamaps.util.WindowInsetUtils.PaddingInsetsListener;
...
public class DownloadResourcesLegacyActivity extends BaseMwmFragmentActivity
{
  ...
  private final app.mexamaps.sdk.DownloadResourcesLegacyActivity.Listener mResourcesDownloadListener =
      new app.mexamaps.sdk.DownloadResourcesLegacyActivity.Listener() {
        @Override
  ...
  public void showMap()
  {
    ...
    // https://github.com/mexamaps/mexamaps/issues/6944
