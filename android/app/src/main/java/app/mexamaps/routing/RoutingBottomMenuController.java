...
import app.mexamaps.sdk.routing.RouteAltitudeData;
...
import app.mexamaps.sdk.routing.TransitStepInfo;
...
import app.mexamaps.widget.RoutingProgressButton;
import app.mexamaps.widget.recycler.DotDividerItemDecoration;
import app.mexamaps.widget.recycler.MultilineLayoutManager;
...
final class RoutingBottomMenuController implements View.OnClickListener
{
                                      ...
                                      @NonNull RoutingBottomMenuListener listener)
  {
    ...
    mStart.setOnClickListener(v -> {
      ...
      // https://github.com/mexamaps/mexamaps/issues/6628
