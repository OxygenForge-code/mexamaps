...
import app.mexamaps.sdk.widget.roadshield.RoadShieldUtils;
import app.mexamaps.sdk.widgets.lanes.LanesView;
import app.mexamaps.sdk.widgets.speedlimit.SpeedLimitView;
...
import app.mexamaps.widget.menu.NavMenu;
...
public class NavigationController implements TrafficManager.TrafficCallback, NavMenu.NavMenuListener
{
  ...
  private void updateStreetView(@NonNull RoutingInfo info)
  {
    ...
    // https://github.com/mexamaps/mexamaps/issues/3732
