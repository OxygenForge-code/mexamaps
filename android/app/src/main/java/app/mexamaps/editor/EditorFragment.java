...
import app.mexamaps.base.BaseMwmFragment;
import app.mexamaps.dialog.EditTextDialogFragment;
import app.mexamaps.editor.data.TimeFormatUtils;
import app.mexamaps.sdk.Framework;
import app.mexamaps.sdk.bookmarks.data.Metadata;
import app.mexamaps.sdk.editor.Editor;
import app.mexamaps.sdk.editor.OpeningHours;
import app.mexamaps.sdk.editor.data.LocalizedName;
import app.mexamaps.sdk.editor.data.LocalizedStreet;
import app.mexamaps.sdk.editor.data.Timetable;
import app.mexamaps.sdk.util.StringUtils;
import app.mexamaps.sdk.util.Utils;
import app.mexamaps.util.Graphics;
...
public class EditorFragment extends BaseMwmFragment implements View.OnClickListener
{
  ...
  public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState)
  {
    ...
    // TODO Reimplement this to avoid https://github.com/mexamaps/mexamaps/issues/9049
