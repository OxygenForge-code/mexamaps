package app.mexamaps.widget.placepage;

import static android.view.View.GONE;
import static android.view.View.VISIBLE;
import static app.mexamaps.sdk.util.Utils.getLocalizedFeatureType;
import static app.mexamaps.sdk.util.Utils.getTagValueLocalized;
...
import app.mexamaps.bookmarks.BookmarksSharingHelper;
import app.mexamaps.bookmarks.ChooseBookmarkCategoryFragment;
import app.mexamaps.downloader.DownloaderStatusIcon;
import app.mexamaps.downloader.MapManagerHelper;
import app.mexamaps.sdk.Framework;
import app.mexamaps.sdk.bookmarks.data.Bookmark;
import app.mexamaps.sdk.bookmarks.data.BookmarkCategory;
import app.mexamaps.sdk.bookmarks.data.BookmarkManager;
import app.mexamaps.sdk.bookmarks.data.BookmarkSharingResult;
import app.mexamaps.sdk.bookmarks.data.DistanceAndAzimut;
import app.mexamaps.sdk.bookmarks.data.FileType;
import app.mexamaps.sdk.bookmarks.data.Icon;
import app.mexamaps.sdk.bookmarks.data.MapObject;
import app.mexamaps.sdk.bookmarks.data.Metadata;
import app.mexamaps.sdk.bookmarks.data.Track;
import app.mexamaps.sdk.bookmarks.data.TrackRecording;
import app.mexamaps.sdk.bookmarks.data.TrackSelectionCandidate;
...
import app.mexamaps.sdk.location.LocationCompatExtractor;
...
import app.mexamaps.sdk.util.concurrency.UiThread;
import app.mexamaps.sdk.widget.placepage.CoordinatesFormatEntry;
import app.mexamaps.sdk.widget.placepage.RouteInfo;
...
import app.mexamaps.utils.Graphics;
import app.mexamaps.widget.ArrowPopup;
import app.mexamaps.widget.ArrowView;
import app.mexamaps.widget.colorpicker.ColorPickerFragment;
import app.mexamaps.widget.placepage.sections.PlacePageLinksFragment;
import app.mexamaps.widget.placepage.sections.PlacePageNotesFragment;
import app.mexamaps.widget.placepage.sections.PlacePageOpeningHoursFragment;
import app.mexamaps.widget.placepage.sections.PlacePagePhoneFragment;
import app.mexamaps.widget.placepage.sections.PlacePageProductsFragment;
import app.mexamaps.widget.placepage.sections.PlacePageTrackFragment;
import app.mexamaps.widget.placepage.sections.PlacePageTrackRecordingFragment;
import app.mexamaps.widget.placepage.sections.PlacePageWikipediaFragment;
...

{
  ...
  private void refreshDetails()
  {
    ...
    refreshMetadataOrHide(mMapObject.hasAtm() ? getString(app.mexamaps.sdk.R.string.type_amenity_atm) : "", mAtm,
                          mTvAtm);
