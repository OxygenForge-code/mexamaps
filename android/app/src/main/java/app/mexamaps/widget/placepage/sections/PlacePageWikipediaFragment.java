...
import app.mexamaps.widget.placepage.WikiArticleActivity;
...
public class PlacePageWikipediaFragment extends Fragment implements Observer<MapObject>
{
  ...
  {
    // There are two sources of wiki info in MexaMaps:
    // wiki links from OpenStreetMaps, and wiki pages explicitly parsed into MexaMaps.
