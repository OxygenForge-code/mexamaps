package app.mexamaps.widget.colorpicker
...
import app.mexamaps.sdk.bookmarks.data.PredefinedColors
...
class ColorPickerViewModel(application: Application, private val savedStateHandle: SavedStateHandle) :
    ...
    companion object {
        ...
        // Default preset swatches: the canonical MexaMaps brand palette from the core, shared
