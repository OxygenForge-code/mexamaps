...
import app.mexamaps.background.OsmUploadWork;
import app.mexamaps.downloader.DownloaderNotifier;
...
import app.mexamaps.sdk.location.SensorHelper;
import app.mexamaps.sdk.location.TrackRecorder;
import app.mexamaps.sdk.maplayer.isolines.IsolinesManager;
import app.mexamaps.sdk.maplayer.subway.SubwayManager;
...
public class MwmApplication extends Application implements Application.ActivityLifecycleCallbacks
{
  ...
  {
    return getMexaMaps().getSubwayManager();
  }

  @NonNull
  public IsolinesManager getIsolinesManager()
  {
    return getMexaMaps().getIsolinesManager();
  }

  @NonNull
  public LocationHelper getLocationHelper()
  {
    return getMexaMaps().getLocationHelper();
  }

  @NonNull
  public SensorHelper getSensorHelper()
  {
    return getMexaMaps().getSensorHelper();
  }
  ...
  {
    return from(context).getMexaMaps().getPreferences();
  }
  ...
  public void onCreate()
  {
    ...
    mMexaMaps = new MexaMaps(getApplicationContext(), BuildConfig.FLAVOR, BuildConfig.APPLICATION_ID,
  ...
  public boolean initMexaMaps(@Nullable Runnable onComplete) throws IOException
  {
    ThemeSwitcher.INSTANCE.initialize(this);
    return mMexaMaps.init(() -> {
  ...
  private void initNavigationService()
  {
    ...
    NavigationService.setMexaMaps(getMexaMaps());
