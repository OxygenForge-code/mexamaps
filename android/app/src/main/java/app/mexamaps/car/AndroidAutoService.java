...
public final class AndroidAutoService extends CarAppServiceBase
{
  ...
  {
    return new AndroidAutoSession(mMexaMapsContext, sessionInfo, /* isDebug */ BuildConfig.DEBUG, mInitFailed);
  }
  ...
  public void onCreate()
  {
    ...
    mMexaMapsContext = app.getMexaMaps();
    if (!mMexaMapsContext.arePlatformAndCoreInitialized())
    {
      try
      {
        app.initMexaMaps(null);
      }
      catch (IOException e)
      {
