...
import app.mexamaps.car.screens.bookmarks.BookmarkCategoriesScreen;
import app.mexamaps.car.screens.search.SearchScreen;
import app.mexamaps.car.screens.settings.SettingsScreen;
import app.mexamaps.car.util.SuggestionsHelpers;
...
{
  public MapScreen(@NonNull CarContext carContext, @NonNull MexaMaps organicMapsContext,
  ...
  private Header createHeader()
  {
    ...
    builder.setTitle(getCarContext().getString(app.mexamaps.branding.R.string.app_name));
    return builder.build();
  }
  ...
  private ActionStrip createActionStrip()
  {
    ...
    freeDriveScreenBuilder.setOnClickListener(()
                                                  -> getScreenManager().push(new FreeDriveScreen(
                                                      getCarContext(), getMexaMapsContext(), getSurfaceRenderer())));
  ...
  private void openSearch()
  {
    ...
    getScreenManager().push(
        new SearchScreen.Builder(getCarContext(), getMexaMapsContext(), getSurfaceRenderer()).build());
  }
  ...
  private void openCategories()
  {
    ...
    if (getScreenManager().getTop() != this)
      return;
    getScreenManager().push(new CategoriesScreen(getCarContext(), getMexaMapsContext(), getSurfaceRenderer()));
  }
  ...
  private void openBookmarks()
  {
    ...
    if (getScreenManager().getTop() != this)
      return;
    getScreenManager().push(
        new BookmarkCategoriesScreen(getCarContext(), getMexaMapsContext(), getSurfaceRenderer()));
  }
  ...
  private void openSettings()
  {
    ...
    if (getScreenManager().getTop() != this)
      return;
    getScreenManager().push(new SettingsScreen(getCarContext(), getMexaMapsContext(), getSurfaceRenderer()));
  }
}
