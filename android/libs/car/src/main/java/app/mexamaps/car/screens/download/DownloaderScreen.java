...
import app.mexamaps.downloader.ErrorCodeHelper;
...
class DownloaderScreen extends BaseScreen
{
  ...
  DownloaderScreen(@NonNull final CarContext carContext, @NonNull MexaMaps organicMapsContext,
  ...
  private void onError(@NonNull final MapManager.StorageCallbackData data)
  {
    ...
    final ErrorScreen.Builder builder = new ErrorScreen.Builder(getCarContext(), getMexaMapsContext())
