package app.mexamaps.car.screens.settings;
...
public class SettingsScreen extends BaseMapScreen
{
  ...
  public SettingsScreen(@NonNull CarContext carContext, @NonNull MexaMaps organicMapsContext,
  ...
  private Item createThemeItem()
  {
    ...
    builder.setOnClickListener(
        () -> getScreenManager().push(new ThemeScreen(getCarContext(), getMexaMapsContext(), getSurfaceRenderer())));
  ...
  private Item createHelpItem()
  {
    ...
    builder.setOnClickListener(
        () -> getScreenManager().push(new HelpScreen(getCarContext(), getMexaMapsContext(), getSurfaceRenderer())));
    builder.setBrowsable(true);
    return builder.build();
  }
