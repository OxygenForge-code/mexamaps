...
public class BookmarksScreen extends BaseMapScreen
{
  ...
  public BookmarksScreen(@NonNull CarContext carContext, @NonNull MexaMaps organicMapsContext,
  ...
  private Action createSortingAction()
  {
    ...
    builder.setOnClickListener(() -> {
      ...
      getScreenManager().pushForResult(
          new SortingScreen(getCarContext(), getMexaMapsContext(), getSurfaceRenderer(), mBookmarkCategory),
