package app.mexamaps.car.screens;
...
import app.mexamaps.car.R;
import app.mexamaps.car.screens.download.DownloadMapsScreenBuilder;
import app.mexamaps.car.screens.settings.DrivingOptionsScreen;
import app.mexamaps.car.util.Colors;
import app.mexamaps.car.util.UiHelpers;
...
import app.mexamaps.sdk.car.OnBackPressedCallback;
import app.mexamaps.sdk.car.RoutingHelpers;
...
public class PlaceScreen extends BaseMapScreen implements OnBackPressedCallback.Callback, RoutingController.Container
{
  ...
  {
    super(builder.mCarContext, builder.mMexaMapsContext, builder.mSurfaceRenderer);
        ...
        .setOnClickListener(
            ()
                -> getScreenManager().pushForResult(
                    new DrivingOptionsScreen(getCarContext(), getMexaMapsContext(), getSurfaceRenderer()),
  ...
  public void showNavigation(boolean show)
  {
    if (show)
    {
      ...
      getScreenManager().push(
          new NavigationScreen.Builder(getCarContext(), getMexaMapsContext(), getSurfaceRenderer())
  ...
  public void onCommonBuildError(int lastResultCode, @NonNull String[] lastMissingMaps)
  {
    if (ResultCodesHelper.isDownloadable(lastResultCode, lastMissingMaps.length))
      getScreenManager().pushForResult(
          new DownloadMapsScreenBuilder(getCarContext(), getMexaMapsContext())
  ...
  public static final class Builder
  {
    ...
    public Builder(@NonNull final CarContext carContext, @NonNull MexaMaps organicMapsContext,
