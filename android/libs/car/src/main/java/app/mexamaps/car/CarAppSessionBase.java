...
import app.mexamaps.car.screens.PlaceScreen;
import app.mexamaps.car.screens.download.DownloadMapsScreen;
import app.mexamaps.car.util.CurrentCountryChangedListener;
import app.mexamaps.car.util.ThemeUtils;
...
import app.mexamaps.sdk.car.CarSensorsManager;
import app.mexamaps.sdk.car.renderer.Renderer;
import app.mexamaps.sdk.car.renderer.RendererFactory;
import app.mexamaps.sdk.car.screens.BaseMapScreen;
    ...
    extends Session implements DefaultLifecycleObserver, LocationState.ModeChangeListener, PlacePageActivationListener
{
  ...
  @NonNull
  protected final MexaMaps mMexaMapsContext;
  @Nullable
  ...
  public CarAppSessionBase(@NonNull MexaMaps organicMapsContext, @Nullable SessionInfo sessionInfo, boolean isDebug)
  {
  ...
  public void onCreate(@NonNull LifecycleOwner owner)
  {
    Logger.d(TAG);
    mSurfaceRenderer =
        RendererFactory.create(getCarContext(), mDisplayManager, mMexaMapsContext.getLocationHelper(), owner);
    mSensorsManager = new CarSensorsManager(getCarContext(), mMexaMapsContext.getSensorHelper(),
                                            mMexaMapsContext.getLocationHelper());
  }
  ...
  public void onStart(@NonNull LifecycleOwner owner)
  {
    ...
    if (isCarScreenUsed())
    {
      ...
      mCurrentCountryChangedListener.onStart(getCarContext(), mMexaMapsContext);
    }
  ...
  public void onPlacePageActivated(@NonNull PlacePageData data)
  {
    ...
    final PlaceScreen placeScreen = new PlaceScreen.Builder(getCarContext(), mMexaMapsContext, mSurfaceRenderer)
