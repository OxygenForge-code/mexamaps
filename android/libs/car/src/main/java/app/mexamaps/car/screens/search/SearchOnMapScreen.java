package app.mexamaps.car.screens.search;
...
import app.mexamaps.sdk.search.SearchListener;
import app.mexamaps.sdk.search.SearchRecents;
import app.mexamaps.sdk.search.SearchResult;
...
public class SearchOnMapScreen extends BaseMapScreen implements SearchListener
{
  ...
  private Row createResultItem(@NonNull SearchResult result, int resultIndex)
  {
    ...
    else
    {
      ...
      builder.setOnClickListener(
          ()
              -> getScreenManager().push(new Builder(getCarContext(), getMexaMapsContext(), getSurfaceRenderer())
  ...
  public static final class Builder
  {
    ...
    public Builder(@NonNull CarContext carContext, @NonNull MexaMaps organicMapsContext,
