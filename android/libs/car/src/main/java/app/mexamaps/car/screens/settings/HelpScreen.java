...
{
  public HelpScreen(@NonNull CarContext carContext, @NonNull MexaMaps organicMapsContext,
  ...
  private Item createVersionInfo()
  {
    return new Row.Builder()
        .setTitle(getCarContext().getString(app.mexamaps.branding.R.string.app_name))
        .addText(getMexaMapsContext().getVersionName())
        .build();
  }
