package app.mexamaps.car.screens.permissions;
...
import app.mexamaps.sdk.car.screens.BaseScreen;
...
public class RequestPermissionsScreenWithApi extends BaseScreen implements UserActionRequired
{
  ...
  public RequestPermissionsScreenWithApi(@NonNull CarContext carContext, @NonNull MexaMaps organicMapsContext,
  ...
  protected Template onGetTemplateImpl()
  {
    ...
    headerBuilder.setTitle(getCarContext().getString(app.mexamaps.branding.R.string.app_name));
                                          ...
                                          @NonNull List<String> rejectedPermissions)
  {
    ...
    {
      getScreenManager().push(new ErrorScreen.Builder(getCarContext(), getMexaMapsContext())
