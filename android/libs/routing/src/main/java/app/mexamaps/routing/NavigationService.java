...
import static app.mexamaps.sdk.util.Constants.Vendor.XIAOMI;
...
import app.mexamaps.sdk.routing.RoutingInfo;
import app.mexamaps.sdk.sound.MediaPlayerWrapper;
import app.mexamaps.sdk.sound.TtsPlayer;
import app.mexamaps.sdk.util.Assert;
import app.mexamaps.sdk.util.Config;
import app.mexamaps.sdk.util.Graphics;
...
public class NavigationService extends Service implements LocationListener
{
  ...
  private static MexaMaps sMexaMaps;
  @Nullable
  ...
  public static void setMexaMaps(@NonNull MexaMaps organicMaps)
  {
    sMexaMaps = organicMaps;
  }
  ...
  public static NotificationCompat.Builder getNotificationBuilder(@NonNull Context context)
  {
    ...
    mNotificationBuilder = new NotificationCompat.Builder(appContext, CHANNEL_ID)
                               ...
                               .setSmallIcon(app.mexamaps.branding.R.drawable.ic_splash)
  ...
  {
    Logger.i(TAG);
    Assert.always(sMexaMaps != null, "MexaMaps instance must be set before starting NavigationService");
  ...
  public void onDestroy()
  {
    ...
    sMexaMaps.getLocationHelper().removeListener(this);
  ...
  public int onStartCommand(@NonNull Intent intent, int flags, int startId)
  {
    ...
    if (!sMexaMaps.arePlatformAndCoreInitialized())
    {
      ...
      // https://github.com/mexamaps/mexamaps/issues/6233
    ...
    final LocationHelper locationHelper = sMexaMaps.getLocationHelper();
  ...
  public void onLocationUpdated(@NonNull Location location)
  {
    ...
    // the core to the platform code (https://github.com/mexamaps/mexamaps/issues/3589),
    ...
    if (Framework.nativeIsRouteFinished())
    {
      ...
      sMexaMaps.getLocationHelper().restartWithNewMode();
      stopSelf();
      return;
    }
      ...
      if (drawable != null)
      {
        mLastTurnBitmap = isColorizedSupported()
                            ...
                            : Graphics.drawableToBitmapWithTint(
                                  drawable, ContextCompat.getColor(this, app.mexamaps.branding.R.color.base_accent));
