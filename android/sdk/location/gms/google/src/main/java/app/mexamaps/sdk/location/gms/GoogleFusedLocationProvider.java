package app.mexamaps.sdk.location.gms;
...
import app.mexamaps.sdk.location.BaseLocationProvider;
  ...
  public void start(long interval)
  {
    ...
    final LocationRequest locationRequest =
        new LocationRequest
            ...
            // device immediately. https://github.com/mexamaps/mexamaps/issues/2149
        ...
        .addOnFailureListener(e -> {
          try
          {
            ...
            if (statusCode == LocationSettingsStatusCodes.RESOLUTION_REQUIRED)
            {
              ...
              //
              // See https://github.com/mexamaps/mexamaps/issues/3846
              //
