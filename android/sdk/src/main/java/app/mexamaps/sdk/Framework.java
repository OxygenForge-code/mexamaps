...
import app.mexamaps.sdk.api.ParsedRoutingData;
...
import app.mexamaps.sdk.products.ProductsConfig;
import app.mexamaps.sdk.routing.JunctionInfo;
import app.mexamaps.sdk.routing.RouteMarkData;
import app.mexamaps.sdk.routing.RouteMarkType;
import app.mexamaps.sdk.routing.RoutingInfo;
import app.mexamaps.sdk.routing.RoutingListener;
import app.mexamaps.sdk.routing.RoutingLoadPointsListener;
import app.mexamaps.sdk.routing.RoutingProgressListener;
import app.mexamaps.sdk.routing.RoutingRecommendationListener;
import app.mexamaps.sdk.routing.TransitRouteInfo;
import app.mexamaps.sdk.settings.SpeedCameraMode;
import app.mexamaps.sdk.util.Constants;
...
public class Framework
{
  ...
  @Nullable
  public static native app.mexamaps.sdk.routing.RouteAltitudeData nativeGetRouteAltitudeData();
