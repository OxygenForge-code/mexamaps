package app.mexamaps.sdk.location;
...
public class LocationHelper implements BaseLocationProvider.Listener
{
  ...
  // https://github.com/mexamaps/mexamaps/issues/11076
  // Probably https://github.com/mexamaps/mexamaps/issues/10133
  // Probably https://github.com/mexamaps/mexamaps/issues/9018
  ...
  private void subscribeToGnssStatusUpdates()
  {
    ...
    // https://github.com/mexamaps/mexamaps/issues/5999#issuecomment-1793713369
    if (!LocationUtils.checkFineLocationPermission(mContext))
      return;
