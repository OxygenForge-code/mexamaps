...
public final class Constants
{
  ...
  public static class Url
  {
    ...
    public static final String HTTP_SHARE_PREFIX = "https://mexamaps.app/";

    public static final String MAILTO_SCHEME = "mailto:";
    public static final String MAIL_SUBJECT = "?subject=";
    public static final String MAIL_BODY = "&body=";

    public static final String FB_OM_COMMUNITY_HTTP = "https://www.facebook.com/MexaMaps";
    public static final String FB_OM_COMMUNITY_NATIVE = "fb://profile/102378968471811";
    public static final String TWITTER = "https://twitter.com/MexaMapsApp";
    public static final String MATRIX = "https://matrix.to/#/%23mexamaps:matrix.org";
    public static final String MASTODON = "https://fosstodon.org/@mexamaps";

    public static final String GITHUB = "https://github.com/mexamaps/mexamaps";
