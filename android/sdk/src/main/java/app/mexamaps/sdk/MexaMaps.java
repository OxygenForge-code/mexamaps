...
import app.mexamaps.sdk.downloader.Android7RootCertificateWorkaround;
...
import app.mexamaps.sdk.maplayer.traffic.TrafficManager;
import app.mexamaps.sdk.routing.RoutingController;
import app.mexamaps.sdk.search.SearchEngine;
import app.mexamaps.sdk.settings.StoragePathManager;
import app.mexamaps.sdk.sound.TtsPlayer;
import app.mexamaps.sdk.util.Config;
import app.mexamaps.sdk.util.ConnectionState;
import app.mexamaps.sdk.util.SharedPropertiesUtils;
import app.mexamaps.sdk.util.StorageUtils;
import app.mexamaps.sdk.util.log.Logger;
import app.mexamaps.sdk.util.log.LogsManager;
import java.io.IOException;

public final class MexaMaps implements DefaultLifecycleObserver
{
  private static final String TAG = MexaMaps.class.getSimpleName();
  ...
  public MexaMaps(@NonNull Context context, @NonNull String flavor, @NonNull String applicationId, int versionCode,
