...
extern "C"
{
JNIEXPORT void Java_app_mexamaps_sdk_search_SearchEngine_nativeInit(JNIEnv * env, jobject thiz)
{
  g_javaListener = env->NewGlobalRef(thiz);
  // public void onResultsUpdate(@NonNull SearchResult[] results, long timestamp)
  g_updateResultsId =
      jni::GetMethodID(env, g_javaListener, "onResultsUpdate", "([Lapp/mexamaps/sdk/search/SearchResult;J)V");
  // public void onResultsEnd(long timestamp)
  g_endResultsId = jni::GetMethodID(env, g_javaListener, "onResultsEnd", "(J)V");
  g_resultClass = jni::GetGlobalClassRef(env, "app/mexamaps/sdk/search/SearchResult");
  g_resultConstructor =
      jni::GetConstructorID(env, g_resultClass,
                            "(Ljava/lang/String;Lapp/mexamaps/sdk/search/SearchResult$Description;DD[I[I"
                            "Lapp/mexamaps/sdk/search/Popularity;)V");
  g_suggestConstructor = jni::GetConstructorID(env, g_resultClass, "(Ljava/lang/String;Ljava/lang/String;DD[I[I)V");
  g_descriptionClass = jni::GetGlobalClassRef(env, "app/mexamaps/sdk/search/SearchResult$Description");
  /*
  ...
  */
  g_descriptionConstructor =
      jni::GetConstructorID(env, g_descriptionClass,
                            "(Ljava/lang/String;Ljava/lang/String;Lapp/mexamaps/sdk/util/Distance;"
                            "Ljava/lang/String;IIIZ)V");

  g_popularityClass = jni::GetGlobalClassRef(env, "app/mexamaps/sdk/search/Popularity");
  ...
  g_mapResultsMethod = jni::GetMethodID(env, g_javaListener, "onMapSearchResults",
                                        "([Lapp/mexamaps/sdk/search/MapSearchListener$Result;JZ)V");
  g_mapResultClass = jni::GetGlobalClassRef(env, "app/mexamaps/sdk/search/MapSearchListener$Result");
...
JNIEXPORT jboolean Java_app_mexamaps_sdk_search_SearchEngine_nativeRunSearch(JNIEnv * env, jclass clazz,
...
JNIEXPORT jboolean Java_app_mexamaps_sdk_search_SearchEngine_nativeRunInteractiveSearch(
...
JNIEXPORT void Java_app_mexamaps_sdk_search_SearchEngine_nativeRunSearchMaps(JNIEnv * env, jclass clazz,
...
JNIEXPORT jboolean Java_app_mexamaps_sdk_search_SearchEngine_nativeRunSearchInBookmarks(JNIEnv * env, jclass clazz,
                                                                                           jbyteArray query,
...
JNIEXPORT void Java_app_mexamaps_sdk_search_SearchEngine_nativeShowResult(JNIEnv * env, jclass clazz, jint index)
{
...
JNIEXPORT void Java_app_mexamaps_sdk_search_SearchEngine_nativeSelectResult(JNIEnv * env, jclass clazz, jint index)
{
  if (index < 0 || index >= static_cast<jint>(g_results.GetCount()))
    return;
...
JNIEXPORT void Java_app_mexamaps_sdk_search_SearchEngine_nativeCancelInteractiveSearch(JNIEnv * env, jclass clazz)
{
  g_framework->NativeFramework()->GetSearchAPI().CancelSearch(search::Mode::Viewport);
}

JNIEXPORT void Java_app_mexamaps_sdk_search_SearchEngine_nativeCancelAllSearches(JNIEnv * env, jclass clazz)
{
