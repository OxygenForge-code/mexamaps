...
extern "C"
{
JNIEXPORT void Java_app_mexamaps_sdk_bookmarks_data_Bookmark_nativeSetColor(JNIEnv *, jclass, jlong bmk, jint color)
{
...
JNIEXPORT void Java_app_mexamaps_sdk_bookmarks_data_Bookmark_nativeUpdateParams(JNIEnv * env, jclass, jlong bmk,
...
JNIEXPORT jstring Java_app_mexamaps_sdk_bookmarks_data_Bookmark_nativeEncode2Ge0Url(JNIEnv * env, jclass, jlong bmk,
                                                                                       jboolean addName)
{
  return jni::ToJavaString(env, frm()->CodeGe0url(getBookmark(bmk), addName));
}

JNIEXPORT void Java_app_mexamaps_sdk_bookmarks_data_Bookmark_nativeChangeCategory(JNIEnv *, jclass, jlong oldCatId,
