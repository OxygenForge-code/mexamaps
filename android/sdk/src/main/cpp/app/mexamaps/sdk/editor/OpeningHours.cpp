...
{
  static jclass const dateUtilsClass = jni::GetGlobalClassRef(env, "app/mexamaps/sdk/util/DateUtils");
...
extern "C"
{
JNIEXPORT void Java_app_mexamaps_sdk_editor_OpeningHours_nativeInit(JNIEnv * env, jclass clazz)
{
  g_clazzHoursMinutes = jni::GetGlobalClassRef(env, "app/mexamaps/sdk/editor/data/HoursMinutes");
  ...
  g_clazzTimespan = jni::GetGlobalClassRef(env, "app/mexamaps/sdk/editor/data/Timespan");
  // Java signature : Timespan(HoursMinutes start, HoursMinutes end)
  g_ctorTimespan = env->GetMethodID(
      g_clazzTimespan, "<init>",
      "(Lapp/mexamaps/sdk/editor/data/HoursMinutes;Lapp/mexamaps/sdk/editor/data/HoursMinutes;)V");
  ASSERT(g_ctorTimespan, (jni::DescribeException()));
  g_fidStart = env->GetFieldID(g_clazzTimespan, "start", "Lapp/mexamaps/sdk/editor/data/HoursMinutes;");
  ASSERT(g_fidStart, (jni::DescribeException()));
  g_fidEnd = env->GetFieldID(g_clazzTimespan, "end", "Lapp/mexamaps/sdk/editor/data/HoursMinutes;");
  ASSERT(g_fidEnd, (jni::DescribeException()));

  g_clazzTimetable = jni::GetGlobalClassRef(env, "app/mexamaps/sdk/editor/data/Timetable");
  ...
  g_ctorTimetable =
      env->GetMethodID(g_clazzTimetable, "<init>",
                       "(Lapp/mexamaps/sdk/editor/data/Timespan;[Lapp/mexamaps/sdk/editor/data/Timespan;Z[I)V");
  ASSERT(g_ctorTimetable, (jni::DescribeException()));
  g_fidWorkingTimespan =
      env->GetFieldID(g_clazzTimetable, "workingTimespan", "Lapp/mexamaps/sdk/editor/data/Timespan;");
  ASSERT(g_fidWorkingTimespan, (jni::DescribeException()));
  g_fidClosedTimespans =
      env->GetFieldID(g_clazzTimetable, "closedTimespans", "[Lapp/mexamaps/sdk/editor/data/Timespan;");
  ...
  g_clazzOpeningHoursInfo = jni::GetGlobalClassRef(env, "app/mexamaps/sdk/editor/data/OpeningHoursInfo");
...
JNIEXPORT jobjectArray Java_app_mexamaps_sdk_editor_OpeningHours_nativeGetDefaultTimetables(JNIEnv * env,
                                                                                               jclass clazz)
{
  TimeTableSet tts;
...
JNIEXPORT jobject Java_app_mexamaps_sdk_editor_OpeningHours_nativeGetComplementTimetable(JNIEnv * env, jclass clazz,
...
JNIEXPORT jobjectArray Java_app_mexamaps_sdk_editor_OpeningHours_nativeRemoveWorkingDay(JNIEnv * env, jclass clazz,
                                                                                           jobjectArray timetables,
...
JNIEXPORT jobjectArray Java_app_mexamaps_sdk_editor_OpeningHours_nativeAddWorkingDay(JNIEnv * env, jclass clazz,
                                                                                        jobjectArray timetables,
                                                                                        jint ttIndex, jint dayIndex)
{
  TimeTableSet tts = NativeTimetableSet(env, timetables);
...
JNIEXPORT jobject Java_app_mexamaps_sdk_editor_OpeningHours_nativeSetIsFullday(JNIEnv * env, jclass clazz,
                                                                                  jobject jTimetable,
                                                                                  jboolean jIsFullday)
{
...
JNIEXPORT jobject Java_app_mexamaps_sdk_editor_OpeningHours_nativeSetOpeningTime(JNIEnv * env, jclass clazz,
                                                                                    jobject jTimetable,
...
JNIEXPORT jobject Java_app_mexamaps_sdk_editor_OpeningHours_nativeAddClosedSpan(JNIEnv * env, jclass clazz,
                                                                                   jobject jTimetable,
                                                                                   jobject jClosedSpan)
{
  TimeTable tt = NativeTimetable(env, jTimetable);
...
JNIEXPORT jobject Java_app_mexamaps_sdk_editor_OpeningHours_nativeRemoveClosedSpan(JNIEnv * env, jclass clazz,
                                                                                      jobject jTimetable,
...
JNIEXPORT jobjectArray Java_app_mexamaps_sdk_editor_OpeningHours_nativeTimetablesFromString(JNIEnv * env,
                                                                                               jclass clazz,
                                                                                               jstring jSource)
{
  TimeTableSet tts;
...
JNIEXPORT jstring Java_app_mexamaps_sdk_editor_OpeningHours_nativeTimetablesToString(JNIEnv * env, jclass clazz,
                                                                                        jobjectArray jTts)
{
...
JNIEXPORT jboolean Java_app_mexamaps_sdk_editor_OpeningHours_nativeIsTimetableStringValid(JNIEnv * env, jclass clazz,
                                                                                             jstring jSource)
{
  return OpeningHours(jni::ToNativeString(env, jSource)).IsValid();
}

JNIEXPORT jobject Java_app_mexamaps_sdk_editor_OpeningHours_nativeGetOpeningHoursInfoFromString(JNIEnv * env,
                                                                                                   jclass clazz,
                                                                                                   jstring jSource,
                                                                                                   jlong jCurrentTime)
{
