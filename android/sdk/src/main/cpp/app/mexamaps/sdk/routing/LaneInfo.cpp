...
{
  static jclass const laneWayClass = jni::GetGlobalClassRef(env, "app/mexamaps/sdk/routing/LaneWay");
  jfieldID fieldID =
      env->GetStaticFieldID(laneWayClass, DebugPrint(laneWay).c_str(), "Lapp/mexamaps/sdk/routing/LaneWay;");
...
jobjectArray CreateLanesInfo(JNIEnv * env, routing::turns::lanes::LanesInfo const & lanes)
{
  ...
  static jclass const laneWayClass = jni::GetGlobalClassRef(env, "app/mexamaps/sdk/routing/LaneWay");
  static jclass const laneInfoClass = jni::GetGlobalClassRef(env, "app/mexamaps/sdk/routing/LaneInfo");
  ...
  static jmethodID const ctorLaneInfoID = jni::GetConstructorID(
      env, laneInfoClass, "([Lapp/mexamaps/sdk/routing/LaneWay;Lapp/mexamaps/sdk/routing/LaneWay;)V");
