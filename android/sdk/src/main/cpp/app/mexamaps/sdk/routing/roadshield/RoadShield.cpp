...
#include "app/mexamaps/sdk/routing/roadshield/RoadShieldType.hpp"

jobject ToJavaRoadShield(JNIEnv * env, ftypes::RoadShield const & roadShield)
{
  static jclass const klass = jni::GetGlobalClassRef(env, "app/mexamaps/sdk/routing/roadshield/RoadShield");
  // clang-format off
  static jmethodID const ctorRouteInfoID = jni::GetConstructorID(env, klass,
    "("
    "Lapp/mexamaps/sdk/routing/roadshield/RoadShieldType;"  // type
