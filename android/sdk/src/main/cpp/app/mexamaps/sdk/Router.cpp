...
extern "C"
{
JNIEXPORT void Java_app_mexamaps_sdk_Router_nativeSet(JNIEnv *, jclass, jint routerType)
{
...
JNIEXPORT jint Java_app_mexamaps_sdk_Router_nativeGet(JNIEnv *, jclass)
{
  return static_cast<jint>(frm()->GetRoutingManager().GetRouter());
}

JNIEXPORT jint Java_app_mexamaps_sdk_Router_nativeGetLastUsed(JNIEnv *, jclass)
{
  return static_cast<jint>(frm()->GetRoutingManager().GetLastUsedRouter());
}

JNIEXPORT jint Java_app_mexamaps_sdk_Router_nativeGetBest(JNIEnv *, jclass, jdouble srcLat, jdouble srcLon,
