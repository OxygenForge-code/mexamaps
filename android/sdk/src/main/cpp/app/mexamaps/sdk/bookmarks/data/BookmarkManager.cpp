...
#include "app/mexamaps/sdk/bookmarks/data/Bookmark.hpp"
#include "app/mexamaps/sdk/bookmarks/data/BookmarkCategory.hpp"
...
void PrepareClassRefs(JNIEnv * env)
{
  ...
  g_bookmarkManagerClass = jni::GetGlobalClassRef(env, "app/mexamaps/sdk/bookmarks/data/BookmarkManager");
  g_bookmarkManagerInstanceField = jni::GetStaticFieldID(env, g_bookmarkManagerClass, "INSTANCE",
                                                         "Lapp/mexamaps/sdk/bookmarks/data/BookmarkManager;");
  ...
  g_onPreparedFileForSharingMethod = jni::GetMethodID(env, bookmarkManagerInstance, "onPreparedFileForSharing",
                                                      "(Lapp/mexamaps/sdk/bookmarks/data/BookmarkSharingResult;)V");

  g_longClass = jni::GetGlobalClassRef(env, "java/lang/Long");
  g_longConstructor = jni::GetConstructorID(env, g_longClass, "(J)V");
  g_sortedBlockClass = jni::GetGlobalClassRef(env, "app/mexamaps/sdk/bookmarks/data/SortedBlock");
  ...
  g_onBookmarksSortingCompleted = jni::GetMethodID(env, bookmarkManagerInstance, "onBookmarksSortingCompleted",
                                                   "([Lapp/mexamaps/sdk/bookmarks/data/SortedBlock;J)V");
  g_onBookmarksSortingCancelled = jni::GetMethodID(env, bookmarkManagerInstance, "onBookmarksSortingCancelled", "(J)V");
  g_bookmarkInfoClass = jni::GetGlobalClassRef(env, "app/mexamaps/sdk/bookmarks/data/BookmarkInfo");
  g_bookmarkInfoConstructor = jni::GetConstructorID(env, g_bookmarkInfoClass,
                                                    ...
                                                    "I"                   // color
                                                    "I"                   // iconType
                                                    "Lapp/mexamaps/sdk/bookmarks/data/ParcelablePointD;"  // coords
                                                    "D"                                                      // scale
...
void OnPreparedFileForSharing(JNIEnv * env, BookmarkManager::SharingResult const & result)
{
  static jclass const classBookmarkSharingResult =
      jni::GetGlobalClassRef(env, "app/mexamaps/sdk/bookmarks/data/BookmarkSharingResult");
...
extern "C"
{
JNIEXPORT void Java_app_mexamaps_sdk_bookmarks_data_BookmarkManager_nativeShowBookmarkOnMap(JNIEnv *, jobject,
                                                                                               jlong bmkId)
{
...
Java_app_mexamaps_sdk_bookmarks_data_BookmarkManager_nativeShowBookmarkCategoryOnMap(JNIEnv *, jobject, jlong catId)
{
  frm()->ShowBookmarkCategory(static_cast<kml::MarkGroupId>(catId), true /* animated */);
}

JNIEXPORT void Java_app_mexamaps_sdk_bookmarks_data_BookmarkManager_nativeLoadBookmarks(JNIEnv * env, jclass)
{
...
JNIEXPORT jlong Java_app_mexamaps_sdk_bookmarks_data_BookmarkManager_nativeCreateCategory(JNIEnv * env, jobject,
                                                                                             jstring name)
{
...
JNIEXPORT jboolean Java_app_mexamaps_sdk_bookmarks_data_BookmarkManager_nativeDeleteCategory(JNIEnv *, jobject,
                                                                                                jlong catId)
{
...
JNIEXPORT void Java_app_mexamaps_sdk_bookmarks_data_BookmarkManager_nativeDeleteBookmark(JNIEnv *, jobject,
                                                                                            jlong bmkId)
{
  frm()->GetBookmarkManager().GetEditSession().DeleteBookmark(static_cast<kml::MarkId>(bmkId));
}

JNIEXPORT void Java_app_mexamaps_sdk_bookmarks_data_BookmarkManager_nativeDeleteTrack(JNIEnv *, jobject, jlong trkId)
{
  frm()->GetBookmarkManager().GetEditSession().DeleteTrack(static_cast<kml::TrackId>(trkId));
}

JNIEXPORT jobject Java_app_mexamaps_sdk_bookmarks_data_BookmarkManager_nativeAddBookmarkToLastEditedCategory(
...
JNIEXPORT jlong Java_app_mexamaps_sdk_bookmarks_data_BookmarkManager_nativeGetLastEditedCategory(JNIEnv *, jobject)
{
  return static_cast<jlong>(frm()->LastEditedBMCategory());
}

JNIEXPORT jint Java_app_mexamaps_sdk_bookmarks_data_BookmarkManager_nativeGetLastEditedColor(JNIEnv *, jobject)
{
  return static_cast<jint>(kml::GetEffectiveColor(frm()->LastEditedBMColor()).GetARGB());
}

JNIEXPORT void Java_app_mexamaps_sdk_bookmarks_data_BookmarkManager_nativeLoadBookmarksFile(JNIEnv * env, jclass,
                                                                                               jstring path,
...
Java_app_mexamaps_sdk_bookmarks_data_BookmarkManager_nativeIsAsyncBookmarksLoadingInProgress(JNIEnv *, jclass)
{
  return static_cast<jboolean>(frm()->GetBookmarkManager().IsAsyncLoadingInProgress());
}

JNIEXPORT jobject Java_app_mexamaps_sdk_bookmarks_data_BookmarkManager_nativeUpdateBookmarkPlacePage(JNIEnv * env,
                                                                                                        jobject,
                                                                                                        jlong bmkId)
{
  if (!frm()->HasPlacePageInfo())
...
JNIEXPORT void Java_app_mexamaps_sdk_bookmarks_data_BookmarkManager_nativeUpdateTrackPlacePage(JNIEnv * env, jobject)
{
  if (!frm()->HasPlacePageInfo())
    return;
...
JNIEXPORT jobject Java_app_mexamaps_sdk_bookmarks_data_BookmarkManager_nativeGetBookmarkInfo(JNIEnv * env, jobject,
                                                                                                jlong bmkId)
{
...
JNIEXPORT jobject Java_app_mexamaps_sdk_bookmarks_data_BookmarkManager_nativeGetTrack(JNIEnv * env, jobject,
                                                                                         jlong trackId,
                                                                                         jclass trackClazz)
{
  ...
  static jmethodID const cId =
      jni::GetConstructorID(env, trackClazz, "(JJZLjava/lang/String;Lapp/mexamaps/sdk/util/Distance;I)V");
...
JNIEXPORT jboolean JNICALL
Java_app_mexamaps_sdk_bookmarks_data_BookmarkManager_nativeIsUsedCategoryName(JNIEnv * env, jclass, jstring name)
{
  return static_cast<jboolean>(frm()->GetBookmarkManager().IsUsedCategoryName(ToNativeString(env, name)));
}

JNIEXPORT void Java_app_mexamaps_sdk_bookmarks_data_BookmarkManager_nativePrepareForSearch(JNIEnv *, jclass,
                                                                                              jlong catId)
{
...
JNIEXPORT jboolean JNICALL
Java_app_mexamaps_sdk_bookmarks_data_BookmarkManager_nativeAreAllCategoriesInvisible(JNIEnv *, jclass)
{
  return static_cast<jboolean>(frm()->GetBookmarkManager().AreAllCategoriesInvisible());
}

JNIEXPORT jboolean JNICALL
Java_app_mexamaps_sdk_bookmarks_data_BookmarkManager_nativeAreAllCategoriesVisible(JNIEnv *, jclass)
{
  return static_cast<jboolean>(frm()->GetBookmarkManager().AreAllCategoriesVisible());
}

JNIEXPORT void Java_app_mexamaps_sdk_bookmarks_data_BookmarkManager_nativeSetAllCategoriesVisibility(
    JNIEnv *, jclass, jboolean visible)
{
  frm()->GetBookmarkManager().SetAllCategoriesVisibility(static_cast<bool>(visible));
}

JNIEXPORT void Java_app_mexamaps_sdk_bookmarks_data_BookmarkManager_nativePrepareTrackFileForSharing(JNIEnv * env,
                                                                                                        jclass,
                                                                                                        jlong trackId,
                                                                                                        jint fileType)
{
...
JNIEXPORT void Java_app_mexamaps_sdk_bookmarks_data_BookmarkManager_nativePrepareFileForSharing(JNIEnv * env, jclass,
                                                                                                   jlongArray catIds,
                                                                                                   jint fileType)
{
...
JNIEXPORT void Java_app_mexamaps_sdk_bookmarks_data_BookmarkManager_nativeSetNotificationsEnabled(JNIEnv *, jclass,
                                                                                                     jboolean enabled)
{
...
JNIEXPORT jboolean JNICALL
Java_app_mexamaps_sdk_bookmarks_data_BookmarkManager_nativeAreNotificationsEnabled(JNIEnv *, jclass)
{
  return static_cast<jboolean>(frm()->GetBookmarkManager().AreNotificationsEnabled());
}

JNIEXPORT jobject JNICALL
Java_app_mexamaps_sdk_bookmarks_data_BookmarkManager_nativeGetBookmarkCategory(JNIEnv * env, jobject, jlong id)
{
  return ToJavaBookmarkCategory(env, static_cast<kml::MarkGroupId>(id));
}

JNIEXPORT jobjectArray JNICALL
Java_app_mexamaps_sdk_bookmarks_data_BookmarkManager_nativeGetBookmarkCategories(JNIEnv * env, jobject)
{
...
Java_app_mexamaps_sdk_bookmarks_data_BookmarkManager_nativeGetBookmarkCategoriesCount(JNIEnv * env, jobject)
{
  auto const & bm = frm()->GetBookmarkManager();
...
JNIEXPORT jobjectArray Java_app_mexamaps_sdk_bookmarks_data_BookmarkManager_nativeGetChildrenCategories(
...
JNIEXPORT void Java_app_mexamaps_sdk_bookmarks_data_BookmarkManager_nativeGetSortedCategory(
...
JNIEXPORT void JNICALL
Java_app_mexamaps_sdk_bookmarks_data_BookmarkManager_nativeSetElevationCurrentPositionChangedListener(JNIEnv * env,
                                                                                                         jclass)
{
...
JNIEXPORT void JNICALL
Java_app_mexamaps_sdk_bookmarks_data_BookmarkManager_nativeRemoveElevationCurrentPositionChangedListener(JNIEnv *,
                                                                                                            jclass)
{
  frm()->GetBookmarkManager().SetElevationMyPositionChangedCallback(nullptr);
}

JNIEXPORT void Java_app_mexamaps_sdk_bookmarks_data_BookmarkManager_nativeSetElevationActivePoint(
...
JNIEXPORT void JNICALL
Java_app_mexamaps_sdk_bookmarks_data_BookmarkManager_nativeSetElevationActiveChangedListener(JNIEnv * env, jclass)
{
  frm()->GetBookmarkManager().SetElevationActivePointChangedCallback(std::bind(&OnElevationActivePointChanged, env));
}

JNIEXPORT void JNICALL
Java_app_mexamaps_sdk_bookmarks_data_BookmarkManager_nativeRemoveElevationActiveChangedListener(JNIEnv *, jclass)
{
  frm()->GetBookmarkManager().SetElevationActivePointChangedCallback(nullptr);
}

JNIEXPORT jboolean JNICALL
Java_app_mexamaps_sdk_widget_placepage_PlacePageButtonFactory_nativeHasRecentlyDeletedBookmark(JNIEnv *, jclass)
{
