...
extern "C"
{
JNIEXPORT jobjectArray Java_app_mexamaps_sdk_bookmarks_data_Icon_nativeGetBookmarkIconNames(JNIEnv * env, jclass)
{
...
JNINativeMethod const iconMethods[] = {
    {"nativeGetBookmarkIconNames", "()[Ljava/lang/String;",
     reinterpret_cast<void *>(&Java_app_mexamaps_sdk_bookmarks_data_Icon_nativeGetBookmarkIconNames)},
};
}
...
{
  jclass clazz = env->FindClass("app/mexamaps/sdk/bookmarks/data/Icon");
  if (clazz == nullptr)
    return JNI_ERR;
