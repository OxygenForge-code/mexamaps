...
std::string Platform::GetMemoryInfo() const
{
  ...
  static std::shared_ptr<jobject> classLogsManager =
      jni::make_global_ref(env->FindClass("app/mexamaps/sdk/util/log/LogsManager"));
...
Platform::EConnectionType Platform::ConnectionStatus()
{
  ...
  static std::shared_ptr<jobject> clazzConnectionState =
      jni::make_global_ref(env->FindClass("app/mexamaps/sdk/util/ConnectionState"));
...
Platform::ChargingStatus Platform::GetChargingStatus()
{
  ...
  static jclass const clazzBatteryState = jni::GetGlobalClassRef(env, "app/mexamaps/sdk/util/BatteryState");
...
uint8_t Platform::GetBatteryLevel()
{
  ...
  static auto const clazzBatteryState = jni::GetGlobalClassRef(env, "app/mexamaps/sdk/util/BatteryState");
  ASSERT(clazzBatteryState, ());
...
void Platform::AndroidSecureStorage::Init(JNIEnv * env)
{
  ...
  m_secureStorageClass = jni::GetGlobalClassRef(env, "app/mexamaps/sdk/util/SecureStorage");
