...
JNIEXPORT void Java_app_mexamaps_sdk_maplayer_isolines_IsolinesManager_nativeAddListener(JNIEnv * env, jclass clazz,
                                                                                            jobject listener)
{
...
JNIEXPORT void Java_app_mexamaps_sdk_maplayer_isolines_IsolinesManager_nativeRemoveListener(JNIEnv * env,
                                                                                               jclass clazz)
{
...
Java_app_mexamaps_sdk_maplayer_isolines_IsolinesManager_nativeShouldShowNotification(JNIEnv * env, jclass clazz)
{
