...
Java_app_mexamaps_sdk_bookmarks_data_PredefinedColors_nativeGetPredefinedColors(JNIEnv * env, jclass)
{
...
JNINativeMethod const predefinedColorsMethods[] = {
    {"nativeGetPredefinedColors", "()[I",
     reinterpret_cast<void *>(&Java_app_mexamaps_sdk_bookmarks_data_PredefinedColors_nativeGetPredefinedColors)},
};
}
...
{
  jclass clazz = env->FindClass("app/mexamaps/sdk/bookmarks/data/PredefinedColors");
  if (clazz == nullptr)
    return JNI_ERR;
