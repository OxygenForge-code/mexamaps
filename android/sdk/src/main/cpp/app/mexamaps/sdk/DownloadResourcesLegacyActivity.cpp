...
JNIEXPORT jint Java_app_mexamaps_sdk_DownloadResourcesLegacyActivity_nativeGetBytesToDownload(JNIEnv * env,
                                                                                                 jclass clazz)
{
  // clear all
...
JNIEXPORT jint Java_app_mexamaps_sdk_DownloadResourcesLegacyActivity_nativeStartNextFileDownload(JNIEnv * env,
                                                                                                    jclass clazz,
                                                                                                    jobject listener)
{
...
JNIEXPORT void Java_app_mexamaps_sdk_DownloadResourcesLegacyActivity_nativeCancelCurrentFile(JNIEnv * env,
                                                                                                jclass clazz)
{
