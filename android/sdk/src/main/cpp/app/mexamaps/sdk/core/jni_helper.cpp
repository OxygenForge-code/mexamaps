...
#include "app/mexamaps/sdk/bookmarks/data/Icon.hpp"
#include "app/mexamaps/sdk/bookmarks/data/PredefinedColors.hpp"
...
JNIEXPORT jint JNI_OnLoad(JavaVM * jvm, void *)
{
  ...
  g_mapObjectClazz = jni::GetGlobalClassRef(env, "app/mexamaps/sdk/bookmarks/data/MapObject");
  g_trackClazz = jni::GetGlobalClassRef(env, "app/mexamaps/sdk/bookmarks/data/Track");
  g_trackStatisticsClazz = jni::GetGlobalClassRef(env, "app/mexamaps/sdk/bookmarks/data/TrackStatistics");
  g_bookmarkClazz = jni::GetGlobalClassRef(env, "app/mexamaps/sdk/bookmarks/data/Bookmark");
  g_httpClientClazz = jni::GetGlobalClassRef(env, "app/mexamaps/sdk/util/HttpClient");
  g_httpParamsClazz = jni::GetGlobalClassRef(env, "app/mexamaps/sdk/util/HttpClient$Params");
  g_platformSocketClazz = jni::GetGlobalClassRef(env, "app/mexamaps/sdk/location/PlatformSocket");
  g_utilsClazz = jni::GetGlobalClassRef(env, "app/mexamaps/sdk/util/Utils");
  g_loggerClazz = jni::GetGlobalClassRef(env, "app/mexamaps/sdk/util/log/Logger");
  g_keyValueClazz = jni::GetGlobalClassRef(env, "app/mexamaps/sdk/util/KeyValue");
  g_networkPolicyClazz = jni::GetGlobalClassRef(env, "app/mexamaps/sdk/util/NetworkPolicy");
  g_elevationInfoClazz = jni::GetGlobalClassRef(env, "app/mexamaps/sdk/bookmarks/data/ElevationInfo");
  g_uiThreadClazz = jni::GetGlobalClassRef(env, "app/mexamaps/sdk/util/concurrency/UiThread");
...
{
  jclass klass = env->FindClass("app/mexamaps/sdk/bookmarks/data/ParcelablePointD");
  ASSERT(klass, ());
