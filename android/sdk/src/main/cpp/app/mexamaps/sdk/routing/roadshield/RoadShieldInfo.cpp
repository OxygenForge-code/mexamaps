...
#include "app/mexamaps/sdk/routing/roadshield/RoadShield.hpp"
...
jobjectArray ToJavaRoadShieldsArray(JNIEnv * env, ftypes::RoadShieldsSetT const & roadShields)
{
  static jclass const roadShieldClass =
      jni::GetGlobalClassRef(env, "app/mexamaps/sdk/routing/roadshield/RoadShield");
...
{
  static jclass const klass = jni::GetGlobalClassRef(env, "app/mexamaps/sdk/routing/roadshield/RoadShieldInfo");
  // clang-format off
  static jmethodID const ctorRouteInfoID = jni::GetConstructorID(env, klass,
    "("
    "[Lapp/mexamaps/sdk/routing/roadshield/RoadShield;"  // targetRoadShields
