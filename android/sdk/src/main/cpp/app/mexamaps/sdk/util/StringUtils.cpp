...
extern "C"
{
JNIEXPORT jboolean Java_app_mexamaps_sdk_util_StringUtils_nativeIsHtml(JNIEnv * env, jclass thiz, jstring text)
{
  return strings::IsHTML(jni::ToNativeString(env, text));
}

JNIEXPORT jboolean Java_app_mexamaps_sdk_util_StringUtils_nativeContainsNormalized(JNIEnv * env, jclass thiz,
                                                                                      jstring str, jstring substr)
{
  return search::ContainsNormalized(jni::ToNativeString(env, str), jni::ToNativeString(env, substr));
}

JNIEXPORT jobjectArray Java_app_mexamaps_sdk_util_StringUtils_nativeFilterContainsNormalized(JNIEnv * env,
                                                                                                jclass thiz,
                                                                                                jobjectArray src,
                                                                                                jstring jSubstr)
{
...
JNIEXPORT jint Java_app_mexamaps_sdk_util_StringUtils_nativeFormatSpeed(JNIEnv * env, jclass thiz,
                                                                           jdouble metersPerSecond)
{
  return measurement_utils::FormatSpeed(metersPerSecond, measurement_utils::GetMeasurementUnits());
}

JNIEXPORT jobject Java_app_mexamaps_sdk_util_StringUtils_nativeFormatSpeedAndUnits(JNIEnv * env, jclass thiz,
                                                                                      jdouble metersPerSecond)
{
...
JNIEXPORT jobject Java_app_mexamaps_sdk_util_StringUtils_nativeFormatDistance(JNIEnv * env, jclass,
                                                                                 jdouble distanceInMeters)
{
  return ToJavaDistance(env, platform::Distance::CreateFormatted(distanceInMeters));
}

JNIEXPORT jobject Java_app_mexamaps_sdk_util_StringUtils_nativeGetLocalizedDistanceUnits(JNIEnv * env, jclass)
{
...
JNIEXPORT jobject Java_app_mexamaps_sdk_util_StringUtils_nativeGetLocalizedAltitudeUnits(JNIEnv * env, jclass)
{
  auto const localizedUnits = platform::GetLocalizedAltitudeUnits();
  return MakeJavaPair(env, localizedUnits.m_high, localizedUnits.m_low);
}

JNIEXPORT jstring Java_app_mexamaps_sdk_util_StringUtils_nativeGetLocalizedSpeedUnits(JNIEnv * env, jclass)
{
