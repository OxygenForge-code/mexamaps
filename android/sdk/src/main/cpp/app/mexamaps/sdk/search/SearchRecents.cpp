...
extern "C"
{
JNIEXPORT void Java_app_mexamaps_sdk_search_SearchRecents_nativeGetList(JNIEnv * env, jclass, jobject result)
{
...
JNIEXPORT void Java_app_mexamaps_sdk_search_SearchRecents_nativeAdd(JNIEnv * env, jclass, jstring locale,
                                                                       jstring query)
{
...
JNIEXPORT void Java_app_mexamaps_sdk_search_SearchRecents_nativeClear(JNIEnv * env, jclass)
{
