...
#include "app/mexamaps/sdk/core/jni_java_methods.hpp"
...
struct CountryItemBuilder
{
  ...
  {
    m_class = jni::GetGlobalClassRef(env, "app/mexamaps/sdk/downloader/CountryItem");
...
JNIEXPORT jstring Java_app_mexamaps_sdk_downloader_MapManager_nativeGetRoot(JNIEnv * env, jclass clazz)
{
  return jni::ToJavaString(env, GetStorage().GetRootId());
}

// static boolean nativeMoveFile(String oldFile, String newFile);
JNIEXPORT jboolean Java_app_mexamaps_sdk_downloader_MapManager_nativeMoveFile(JNIEnv * env, jclass clazz,
...
JNIEXPORT jboolean Java_app_mexamaps_sdk_downloader_MapManager_nativeHasSpaceToDownloadAmount(JNIEnv * env,
                                                                                                 jclass clazz,
                                                                                                 jlong bytes)
{
...
JNIEXPORT jboolean Java_app_mexamaps_sdk_downloader_MapManager_nativeHasSpaceToDownloadCountry(JNIEnv * env,
                                                                                                  jclass clazz,
                                                                                                  jstring root)
{
...
JNIEXPORT jboolean Java_app_mexamaps_sdk_downloader_MapManager_nativeHasSpaceToUpdate(JNIEnv * env, jclass clazz,
                                                                                         jstring root)
{
...
JNIEXPORT jint Java_app_mexamaps_sdk_downloader_MapManager_nativeGetDownloadedCount(JNIEnv * env, jclass clazz)
{
...
JNIEXPORT jobject Java_app_mexamaps_sdk_downloader_MapManager_nativeGetUpdateInfo(JNIEnv * env, jclass clazz,
                                                                                     jstring root)
{
  ...
  static jclass const infoClass = jni::GetGlobalClassRef(env, "app/mexamaps/sdk/downloader/UpdateInfo");
...
JNIEXPORT void Java_app_mexamaps_sdk_downloader_MapManager_nativeListItems(JNIEnv * env, jclass clazz,
...
JNIEXPORT void Java_app_mexamaps_sdk_downloader_MapManager_nativeGetAttributes(JNIEnv * env, jclass, jobject item)
{
  auto const & ciBuilder = CountryItemBuilder::Instance(env);
...
JNIEXPORT jint Java_app_mexamaps_sdk_downloader_MapManager_nativeGetStatus(JNIEnv * env, jclass clazz, jstring root)
{
...
JNIEXPORT jint Java_app_mexamaps_sdk_downloader_MapManager_nativeGetError(JNIEnv * env, jclass clazz, jstring root)
{
  storage::NodeStatuses ns;
  GetStorage().GetNodeStatuses(jni::ToNativeString(env, root), ns);
...
JNIEXPORT jstring Java_app_mexamaps_sdk_downloader_MapManager_nativeGetName(JNIEnv * env, jclass clazz, jstring root)
{
...
JNIEXPORT jstring Java_app_mexamaps_sdk_downloader_MapManager_nativeFindCountry(JNIEnv * env, jclass clazz,
...
JNIEXPORT jboolean Java_app_mexamaps_sdk_downloader_MapManager_nativeIsDownloading(JNIEnv * env, jclass clazz)
{
...
static void EndBatchingCallbacks(JNIEnv * env)
{
  ...
  static jclass batchDataClass =
      jni::GetGlobalClassRef(env, "app/mexamaps/sdk/downloader/MapManager$StorageCallbackData");
...
JNIEXPORT void Java_app_mexamaps_sdk_downloader_MapManager_nativeDownload(JNIEnv * env, jclass clazz, jstring root)
{
...
JNIEXPORT void Java_app_mexamaps_sdk_downloader_MapManager_nativeRetry(JNIEnv * env, jclass clazz, jstring root)
{
  StartBatchingCallbacks();
...
JNIEXPORT void Java_app_mexamaps_sdk_downloader_MapManager_nativeUpdate(JNIEnv * env, jclass clazz, jstring root)
{
  StartBatchingCallbacks();
...
JNIEXPORT void Java_app_mexamaps_sdk_downloader_MapManager_nativeCancel(JNIEnv * env, jclass clazz, jstring root)
{
  StartBatchingCallbacks();
...
JNIEXPORT void Java_app_mexamaps_sdk_downloader_MapManager_nativeDelete(JNIEnv * env, jclass clazz, jstring root)
{
  StartBatchingCallbacks();
...
JNIEXPORT jint Java_app_mexamaps_sdk_downloader_MapManager_nativeSubscribe(JNIEnv * env, jclass clazz,
                                                                              jobject listener)
{
  // When calling from DownloadService.onCreate
  // https://github.com/mexamaps/mexamaps/issues/11741
  if (!g_framework)
    return 0;
...
JNIEXPORT void Java_app_mexamaps_sdk_downloader_MapManager_nativeUnsubscribe(JNIEnv * env, jclass clazz, jint slot)
{
  if (!g_framework)
    return;
...
JNIEXPORT void Java_app_mexamaps_sdk_downloader_MapManager_nativeSubscribeOnCountryChanged(JNIEnv * env,
                                                                                              jclass clazz,
                                                                                              jobject listener)
{
...
JNIEXPORT void Java_app_mexamaps_sdk_downloader_MapManager_nativeUnsubscribeOnCountryChanged(JNIEnv * env,
                                                                                                jclass clazz)
{
...
JNIEXPORT jboolean Java_app_mexamaps_sdk_downloader_MapManager_nativeHasUnsavedEditorChanges(JNIEnv * env,
                                                                                                jclass clazz,
                                                                                                jstring root)
{
...
JNIEXPORT jint Java_app_mexamaps_sdk_downloader_MapManager_nativeGetOverallProgress(JNIEnv * env, jclass clazz,
...
JNIEXPORT jboolean Java_app_mexamaps_sdk_downloader_MapManager_nativeIsAutoretryFailed(JNIEnv * env, jclass clazz)
{
  return g_framework->IsAutoRetryDownloadFailed();
}

// static boolean nativeIsDownloadOn3gEnabled();
JNIEXPORT jboolean Java_app_mexamaps_sdk_downloader_MapManager_nativeIsDownloadOn3gEnabled(JNIEnv * env,
                                                                                              jclass clazz)
{
...
JNIEXPORT void Java_app_mexamaps_sdk_downloader_MapManager_nativeEnableDownloadOn3g(JNIEnv * env, jclass clazz)
{
  g_framework->EnableDownloadOn3g();
}

// static @Nullable String nativeGetSelectedCountry();
JNIEXPORT jstring Java_app_mexamaps_sdk_downloader_MapManager_nativeGetSelectedCountry(JNIEnv * env, jclass clazz)
{
