...
JNIEXPORT void Java_app_mexamaps_sdk_MexaMaps_nativeSetSettingsDir(JNIEnv * env, jclass clazz,
...
JNIEXPORT void Java_app_mexamaps_sdk_MexaMaps_nativeInitPlatform(JNIEnv * env, jclass clazz, jobject context,
...
JNIEXPORT void Java_app_mexamaps_sdk_MexaMaps_nativeInitFramework(JNIEnv * env, jclass clazz, jobject onComplete)
{
  if (!g_framework)
  {
...
JNIEXPORT void Java_app_mexamaps_sdk_MexaMaps_nativeAddLocalization(JNIEnv * env, jclass clazz, jstring name,
                                                                          jstring value)
{
  g_framework->AddString(jni::ToNativeString(env, name), jni::ToNativeString(env, value));
}

JNIEXPORT void Java_app_mexamaps_sdk_MexaMaps_nativeOnTransit(JNIEnv *, jclass, jboolean foreground)
{
