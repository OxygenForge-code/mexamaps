...
#include "app/mexamaps/sdk/bookmarks/data/ElevationInfo.hpp"
#include "app/mexamaps/sdk/bookmarks/data/Metadata.hpp"
#include "app/mexamaps/sdk/bookmarks/data/TrackStatistics.hpp"
...
jobjectArray BuildTrackCandidatesArray(JNIEnv * env, place_page::Info const & info)
{
  ...
  jni::TScopedLocalClassRef candidateClazz(
      env, env->FindClass("app/mexamaps/sdk/bookmarks/data/TrackSelectionCandidate"));
                    ...
                    jni::TScopedLocalRef const & routingPointInfo)
{
  ...
  static jmethodID const ctorId = jni::GetConstructorID(env, g_trackClazz,
    ...
    "Lapp/mexamaps/sdk/routing/RoutePointInfo;"    // routePointInfo
    "I"                                               // openingMode
    "Ljava/lang/String;"                              // wikiArticle
    "Ljava/lang/String;"                              // osmDescription
    "[Ljava/lang/String;"                             // rawTypes
    "I"                                               // color
    "Lapp/mexamaps/sdk/util/Distance;"             // length
    "D"                                               // lat
    "D"                                               // lon
    "[Lapp/mexamaps/sdk/bookmarks/data/TrackSelectionCandidate;"  // candidates
    ")V"
  );
  // clang-format on
...
extern "C"
{
JNIEXPORT jstring Java_app_mexamaps_sdk_bookmarks_data_Track_nativeGetDescription(JNIEnv * env, jclass, jlong id)
{
  return jni::ToJavaString(env, frm()->GetBookmarkManager().GetTrack(static_cast<kml::TrackId>(id))->GetDescription());
}

JNIEXPORT jobject Java_app_mexamaps_sdk_bookmarks_data_Track_nativeGetElevationInfo(JNIEnv * env, jclass, jlong id)
{
...
JNIEXPORT jobject Java_app_mexamaps_sdk_bookmarks_data_Track_nativeGetStatistics(JNIEnv * env, jclass, jlong id)
{
  return ToJavaTrackStatistics(env, frm()->GetBookmarkManager().GetTrack(id)->GetStatistics());
}

JNIEXPORT jdoubleArray Java_app_mexamaps_sdk_bookmarks_data_Track_nativeGetElevationActivePointCoordinates(
...
JNIEXPORT void Java_app_mexamaps_sdk_bookmarks_data_Track_nativeSetParams(JNIEnv * env, jclass, jlong id,
...
JNIEXPORT void Java_app_mexamaps_sdk_bookmarks_data_Track_nativeChangeColor(JNIEnv *, jclass, jlong id, jint color)
{
...
JNIEXPORT void Java_app_mexamaps_sdk_bookmarks_data_Track_nativeChangeCategory(JNIEnv *, jclass, jlong oldCat,
...
JNIEXPORT jdouble Java_app_mexamaps_sdk_bookmarks_data_Track_nativeGetElevationCurPositionDistance(JNIEnv *, jclass,
                                                                                                      jlong trackId)
{
...
JNIEXPORT jdouble Java_app_mexamaps_sdk_bookmarks_data_Track_nativeGetElevationActivePointDistance(JNIEnv *, jclass,
                                                                                                      jlong trackId)
{
