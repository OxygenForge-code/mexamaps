...
inline jclass getBookmarkCategoryClass(JNIEnv * env)
{
  static jclass g_bookmarkCategoryClass =
      jni::GetGlobalClassRef(env, "app/mexamaps/sdk/bookmarks/data/BookmarkCategory");
...
extern "C"
{
JNIEXPORT void Java_app_mexamaps_sdk_bookmarks_data_BookmarkCategory_nativeSetName(JNIEnv * env, jclass, jlong catId,
                                                                                      jstring name)
{
...
JNIEXPORT void Java_app_mexamaps_sdk_bookmarks_data_BookmarkCategory_nativeSetDescription(JNIEnv * env, jclass,
...
JNIEXPORT jboolean Java_app_mexamaps_sdk_bookmarks_data_BookmarkCategory_nativeIsVisible(JNIEnv *, jclass,
                                                                                            jlong catId)
{
  return static_cast<jboolean>(frm()->GetBookmarkManager().IsVisible(static_cast<kml::MarkGroupId>(catId)));
}

JNIEXPORT void Java_app_mexamaps_sdk_bookmarks_data_BookmarkCategory_nativeSetVisibility(JNIEnv *, jclass,
                                                                                            jlong catId,
                                                                                            jboolean isVisible)
{
...
JNIEXPORT void Java_app_mexamaps_sdk_bookmarks_data_BookmarkCategory_nativeSetTags(JNIEnv * env, jclass, jlong catId,
...
JNIEXPORT void Java_app_mexamaps_sdk_bookmarks_data_BookmarkCategory_nativeSetAccessRules(JNIEnv *, jclass,
                                                                                             jlong catId,
                                                                                             jint accessRules)
{
...
JNIEXPORT void Java_app_mexamaps_sdk_bookmarks_data_BookmarkCategory_nativeSetCustomProperty(JNIEnv * env, jclass,
                                                                                                jlong catId,
                                                                                                jstring key,
                                                                                                jstring value)
{
...
JNIEXPORT jboolean Java_app_mexamaps_sdk_bookmarks_data_BookmarkCategory_nativeIsEmpty(JNIEnv *, jclass, jlong catId)
{
  return static_cast<jboolean>(frm()->GetBookmarkManager().IsCategoryEmpty(static_cast<kml::MarkGroupId>(catId)));
}

JNIEXPORT jlong Java_app_mexamaps_sdk_bookmarks_data_BookmarkCategory_nativeGetBookmarkIdByPosition(
...
JNIEXPORT jlong Java_app_mexamaps_sdk_bookmarks_data_BookmarkCategory_nativeGetTrackIdByPosition(
    JNIEnv *, jclass, jlong catId, jint positionInCategory)
{
...
Java_app_mexamaps_sdk_bookmarks_data_BookmarkCategory_nativeHasLastSortingType(JNIEnv *, jclass, jlong catId)
{
...
JNIEXPORT jint Java_app_mexamaps_sdk_bookmarks_data_BookmarkCategory_nativeGetLastSortingType(JNIEnv *, jclass,
                                                                                                 jlong catId)
{
  auto const & bm = frm()->GetBookmarkManager();
  BookmarkManager::SortingType type;
...
JNIEXPORT void Java_app_mexamaps_sdk_bookmarks_data_BookmarkCategory_nativeSetLastSortingType(JNIEnv *, jclass,
...
JNIEXPORT void Java_app_mexamaps_sdk_bookmarks_data_BookmarkCategory_nativeResetLastSortingType(JNIEnv *, jclass,
                                                                                                   jlong catId)
{
  auto & bm = frm()->GetBookmarkManager();
...
JNIEXPORT jintArray Java_app_mexamaps_sdk_bookmarks_data_BookmarkCategory_nativeGetAvailableSortingTypes(
...
JNIEXPORT void Java_app_mexamaps_sdk_bookmarks_data_BookmarkCategory_nativeSetCategoryBookmarksColor(JNIEnv *,
                                                                                                        jclass,
                                                                                                        jlong catId,
                                                                                                        jint color)
{
...
JNIEXPORT void Java_app_mexamaps_sdk_bookmarks_data_BookmarkCategory_nativeSetCategoryTracksCustomColor(JNIEnv *,
                                                                                                           jclass,
                                                                                                           jlong catId,
                                                                                                           jint color)
{
