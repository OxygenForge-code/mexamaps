#include "android/sdk/src/main/cpp/app/mexamaps/sdk/core/ScopedLocalRef.hpp"
...
std::string GetAndroidSystemLanguage()
{
  ...
  static jclass const languageClass = jni::GetGlobalClassRef(env, "app/mexamaps/sdk/util/Language");
